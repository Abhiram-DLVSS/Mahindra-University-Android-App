...
public class AdapterForms extends RecyclerView.Adapter<AdapterForms.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            textview_heading_form = itemView.findViewById(R.id.textview_heading_assign);
            textview_desc_form = itemView.findViewById(R.id.textview_desc_assign);
            textview_lect_form = itemView.findViewById(R.id.textview_lecturer_assign);
            rv = itemView.findViewById(R.id.assign_rl);
            cv = itemView.findViewById(R.id.assign_card);
            textview_heading_form.setOnClickListener(v -> gotoUrl(link));
            textview_heading_form.setOnLongClickListener(v -> {
