...
public class AdapterMon extends RecyclerView.Adapter<AdapterMon.ViewHolder> {
    ...
    public AdapterMon(List<Listitem_monfrag> listItems_monfrag, Context context_mon) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(context_mon).inflate(R.layout.tt_list_item_monfrag
                ,parent
                ,false);
